...
$query=mysqli_query($con,"select * from courses where courseType='long' and status='AC'");
$cnt=1;
?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>Become A Certified Software Engineer | Apply Now in Syrol Technologies</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Syrol Courses, Syrol Technologies, Study with Syrol"/>
<meta name="description" content="We provide flexible real-time online software development & support training to our clients to get them hired by our top companies around the world. Join now!">
		...
		<nav class="navbar navbar-default">
			...
			<div class="container">
				  <div class="full-page-title">
                      <h1><span>E</span>ngineer<span class="slogan">"Join us Today"</span></h1>
                  </div>   
			</div>
		</div>
	</div>
		...
		<div class="container"> 	
			<div class="sy_agile_team_grid">
				...
				<div class="sy_agile_team_grid_right">
					...
					<p>We will recriuit you, and get you a job. We provide flexible real-time online software development and support training. Enroll today.</p>
				</div>
				...
				<div class="col-md-4 sy_agile_services_grid">
					...
					<div class="agileits_syrol_services_grid1">
						<div class="sy_agileits_services_grid1">
                            ...
                            <a href="apply?cid=<?php echo $row['courseCode'];?>" style="float:right"><button type="button">Apply Now</button></a>
							<div class="clearfix"> </div>
						</div>
						<h4><a href="apply?cid=<?php echo $row['courseCode'];?>"><?php echo $row['courseName'];?></a></h4>
