...
<html lang="en">
<head>
<title>Syrol Academy's Ranked Students</title>
		...
		<div class="wthree_banner1_info">
			<div class="container">
				  <div class="full-page-title">
                      <h1><span>S</span>tudents<span class="slogan">"Ranked Students"</span></h1>
                  </div>   
			</div>
		</div>
	</div>
    ...
    <div class="container">
      ...
      <div class="get-in stayleft fullscreen">
		<div class="sidebar-widget-title">
			<h4>Search <span>Student</span> by Student ID</h4>
		</div>
     <div class="message fullscreen search-section ">
            <form method="post" class="row-fluid fullscreen">
                 <input class="input-block-level" style="text-transform:none" name="regid" id="regid" type="text" maxlength="6" placeholder="Search here">
            </form>
      </div><!-- Message Box -->
